...
let button = document.getElementsByClassName("btn-generate")[0].addEventListener("click", displayQuote);
function getQuote() {
  // TODO: answer here
...
function displayQuote() {
  // TODO: answer here
  let saveQoutes = getQuote();

  quote.innerHTML = saveQoutes.quote;
  author.innerHTML = saveQoutes.author;
  if(saveQoutes.citation === undefined){
    citation.innerHTML = " ";
  } else {
    citation.innerHTML = saveQoutes.citation;
  }

  if(saveQoutes.year === undefined){
    year.innerHTML = " ";
  } else {
    year.innerHTML = saveQoutes.year;
  }
}
